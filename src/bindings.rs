...
fn bindgen_test_layout_napi_property_descriptor() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<napi_property_descriptor>())).utf8name
                as *const _ as usize
        },
        0usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<napi_property_descriptor>())).name
                as *const _ as usize
        },
        8usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<napi_property_descriptor>())).method
                as *const _ as usize
        },
        16usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<napi_property_descriptor>())).getter
                as *const _ as usize
        },
        24usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<napi_property_descriptor>())).setter
                as *const _ as usize
        },
        32usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<napi_property_descriptor>())).value
                as *const _ as usize
        },
        40usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<napi_property_descriptor>())).attributes
                as *const _ as usize
        },
        48usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<napi_property_descriptor>())).data
                as *const _ as usize
        },
        56usize,
        concat!(
...
fn bindgen_test_layout_napi_extended_error_info() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<napi_extended_error_info>())).error_message
                as *const _ as usize
        },
        0usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<napi_extended_error_info>())).engine_reserved
                as *const _ as usize
        },
        8usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<napi_extended_error_info>())).error_code
                as *const _ as usize
        },
        20usize,
        concat!(
...
fn bindgen_test_layout_napi_node_version() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<napi_node_version>())).major as *const _
                as usize
        },
        0usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<napi_node_version>())).minor as *const _
                as usize
        },
        4usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<napi_node_version>())).patch as *const _
                as usize
        },
        8usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<napi_node_version>())).release as *const _
                as usize
        },
        16usize,
        concat!(
...
fn bindgen_test_layout_napi_module() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<napi_module>())).nm_version as *const _
                as usize
        },
        0usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<napi_module>())).nm_flags as *const _
                as usize
        },
        4usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<napi_module>())).nm_filename as *const _
                as usize
        },
        8usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<napi_module>())).nm_register_func as *const _
                as usize
        },
        16usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<napi_module>())).nm_modname as *const _
                as usize
        },
        24usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<napi_module>())).reserved as *const _
                as usize
        },
        40usize,
        concat!(
